				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							<li><a href="http://localhost:8080/Ajinsafro/Acceuil">Home</a></li>
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div class="product-options">
								<label>
									Continent : <strong> ${ voyage.continent } </strong>             	 							
								</label>
								<label>
									Type : <strong> ${ voyage.type } </strong><br>							
								</label>
								<label>
							...
							<c:if test="${idUtilisateur != null}">
								<a href="http://localhost:8080/Ajinsafro/utilisateur_commande?id_c=${ voyage.id_Voyage }&&id_u=${idUtilisateur}" class="add-to-cart">
									
									<button class="add-to-cart-btn"><i class="fa fa-user-o"></i>Réserver Ma Place</button>
								</a>
								<a href="http://localhost:8080/Ajinsafro/panier?id_c=${ voyage.id_Voyage }&&id_u=${idUtilisateur}"  class="add-to-cart">
									
									<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i>Ajouter Panier</button>
								</a>
							</c:if>
							<c:if test="${idUtilisateur == null}">
							<ul class="product-links">
								...
								<a href="http://localhost:8080/Ajinsafro/login_client" class="add-to-cart">
